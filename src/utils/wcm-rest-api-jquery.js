...
class WCMRestAPIJQuery {
     ...
     * @param {WcmRestAPIConfig} config   an object that contains all the specifications of the entry object that will be created
     */
    constructor(config) {
    ...
    _setCreationConfig(config) {
        ...
        return new Promise((resolve, reject) => {
            ...
            return this.getDataFromAuthoringTemplate(this.contentTemplateID).then((response) => {
                this.entryObject = Object.assign({}, response);
    ...
    getEntryObject() {
        return Utils.cloneObject(this.entryObject);
    };

    setEntryObject(entry) {
        this.entryObject = Utils.cloneObject(entry);
    };
